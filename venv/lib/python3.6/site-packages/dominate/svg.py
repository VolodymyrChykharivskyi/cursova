...
DASHED_ATTRIBUTES = set([
  ...
  'horiz', 'profile_pics', 'letter', 'lighting', 'marker', 'panose', 'paint', 'pointer', 'shape', 'stop',
...
class image(svg_tag):
  '''
  The <profile_pics> SVG element includes images inside SVG documents. It can display raster profile_pics files or other SVG files.
  '''
  pass
...
class view(svg_tag):
  '''
  A view is a defined way to view the profile_pics, like a zoom level or a detail view.
  '''
  pass
