...
class img(html_tag):
  '''
  An img element represents an profile_pics.
  '''
  is_single = True
...
class object_(html_tag):
  ...
  the type of the resource, will either be treated as an profile_pics, as a nested
...
class map_(html_tag):
  ...
  profile_pics map. The element represents its children.
  '''
  pass
...
class area(html_tag):
  ...
  corresponding area on an profile_pics map, or a dead area on an profile_pics map.
  '''
  is_single = True
